...
document.getElementById("formLogin").addEventListener("submit", async (e) => {
  ...
  try {
    ...
    // Ajusta la desestructuración según lo que sí devuelves
    const { mensaje, id, nombreUsuario: user } = await response.json();

    console.log(mensaje);               // "Login exitoso"
    // Guarda el id y el usuario en lugar de un token
